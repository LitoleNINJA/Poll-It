...
export default function Home(props) {
    ...
    useEffect(() => {
        const public_polls = props.polls.filter(
            (poll) => poll.visibility === "public"
        );
        if (filter === "Recent") {
            setPolls(
                public_polls.sort(
            ...
            setPolls(
                public_polls.sort((a, b) => b.total_votes - a.total_votes)
            );
        } else if (filter === "My Polls") {
            setPolls(
                props.polls
                    .filter((poll) => poll.username === user.username)
                    .sort(
                        (a, b) => new Date(b.timestamp) - new Date(a.timestamp)
                    )
            );
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        >
                            Polls created by{" "}
                            {filter === "My Polls" ? "You" : "Poll It users"}.
                        </Typography>
                    </Box>
                        ...
                        {showMenu && (
                            <Box
                                ...
                                sx={{
                                    ...
                                    p: "1rem 0",
                                    boxShadow:
                                        "0 4px 21px 0 rgba(49, 49, 49, 0.2)",
                                    borderRadius: "6px",
                                    zIndex: "10",
                                }}
                            >
                            ...
                            >
                                <Box
                                    sx={{
                                        ...
                                        backgroundColor: "#ffffff",
                                        boxShadow:
                                            "0px 7px 14px rgba(0, 0, 0, 0.07)",
                                        borderRadius: "7px",
                                        position: "relative",
                                        ":hover": {
                                            boxShadow:
                                                "0px 10px 44px 10px rgb(233, 235, 243)",
                                            cursor: "pointer",
                                        },
                                    }}
                                >
                                    ...
                                    >
                                        <Typography
                                            ...
                                            sx={{
                                                ...
                                                boxShadow:
                                                    "0px 7px 14px rgba(74, 217, 127, 0.2)",
                                                borderRadius: "25px",
                                                fontWeight: "700",
                                                color: "#678873",
                                                p: "0.5rem 1rem",
